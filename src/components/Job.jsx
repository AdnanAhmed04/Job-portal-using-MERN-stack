...
Experience with deployment, CI/CD, and version control is a plus.`,
        ...
        skills: 'React - Node - JavaScript - Express - MongoDB - SQL - Next.js - API - Git - CI/CD'
...
Experience with APIs and version control (Git) is essential.`,
        ...
        skills: 'HTML - CSS - JavaScript - React - Vue - Tailwind - Responsive Design - API - Git - Webpack'
...
A strong portfolio showcasing UI/UX skills is required.`,
        ...
        skills: 'Figma - Adobe XD - Sketch - Wireframing - Prototyping - User Research - UX Writing - Accessibility - Design Systems - Interaction Design'
...
Familiarity with RESTful APIs and cloud platforms is preferred.`,
        ...
        skills: 'Node.js - Express - Python - Django - REST API - MongoDB - SQL - PostgreSQL - JWT - Cloud Functions'
...
Strong communication, leadership, and organizational skills are essential.`,
        ...
        skills: 'Recruitment - Onboarding - Payroll - HR Policies - Employee Relations - Compliance - Interviews - Performance Management - Communication - Leadership'
...
Strong communication, negotiation, and persuasive skills are vital.`,
        ...
        skills: 'Lead Generation - Cold Calling - Negotiation - CRM Tools - Market Analysis - Communication - Sales Pitching - Relationship Building - Reporting - Target Achievement'
...
Strong analytical, statistical, and problem-solving skills are essential.`,
        ...
        skills: 'SQL - Excel - Python - Power BI - Tableau - Data Cleaning - Data Visualization - Statistics - Pandas - Reporting'
...
Excellent leadership and problem-solving abilities are required.`,
        ...
        skills: 'Project Planning - Jira - Trello - Asana - Budget Management - Risk Management - Communication - Agile - Scrum - Leadership'
